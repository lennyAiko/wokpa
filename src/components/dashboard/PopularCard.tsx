    ...
    return (
        <>
            <div className="bg-[#30303080] shrink-0 rounded-[3px] w-[220px] shadow-md">
                <img src={posterImg} alt={`${author} image`} />
                ...
                <span className="flex px-3 py-3 w-[220px] items-center relative">
                    <img src={subImg1} alt={`subsribers image`} className="w-7 h-7 rounded-full border-2 object-cover border-[#7B61FF] m-0 absolute" />

                    <img src={subImg2} alt={`subsribers image`} className="w-7 h-7 rounded-full border-2 object-cover border-[#7B61FF] m-0 absolute left-[15%]" />

                    <img src={subImg3} alt={`subsribers image`} className="w-7 h-7 rounded-full border-2 object-cover border-[#7B61FF] m-0 absolute left-[25%] z-10" />
